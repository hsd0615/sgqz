package com.greensock.loading
{
   ...
   public class SWFLoader extends DisplayObjectLoader
   {
      ...
      public function getClass(param1:String) : Class
      {
         ...
         var _loc4_:Object;
         if((_loc4_ = _content.loaderInfo.applicationDomain.getDefinition(param1)) != null)
         {
            return _loc4_ as Class;
         }
         if(this._queue != null)
         {
            _loc2_ = this._queue.getChildren(true,true);
            _loc3_ = int(_loc2_.length);
            while(--_loc3_ > -1)
            {
               if(_loc2_[_loc3_] is SWFLoader)
               {
                  if((_loc4_ = (_loc2_[_loc3_] as SWFLoader).getClass(param1)) != null)
                  {
                     return _loc4_ as Class;
                  }
               }
      ...
      override protected function _initHandler(param1:Event) : void
      {
         ...
         try
         {
            ...
            {
               if((_loc4_ = _loc2_["__rslPreloader"]) != null)
               {
