package com.greensock.loading.core
{
   ...
   public class LoaderCore extends EventDispatcher
   {
      ...
      protected function _dump(param1:int = 0, param2:int = 0, param3:Boolean = false) : void
      {
         ...
         this._content = null;
         var _loc5_:Boolean = Boolean(this._status == LoaderStatus.LOADING);
      ...
      {
         var _loc2_:Object = param1 is LoaderEvent && Boolean(this.hasOwnProperty("getChildren")) ? param1.target : this;
