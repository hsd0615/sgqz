package com.iflashigame.controller
{
   ...
   public class Test implements IControllerTest
   {
      ...
      public function getData(param1:Object) : Object
      {
         switch(param1.head)
         {
            case Head.HTTP_NEW_LOGIN:
               return this.httpLogin(param1);
            case Head.HTTP_NEW_ACTIVE:
            ...
            case Head.HTTP_NEW_FIGHT_PREPARE:
               return {"success":true, "data":{"enemyEquips":[], "dropNotify":null}};
            case Head.HTTP_NEW_FUBEN_PREPARE:
               return {"success":true, "data":{}};
      ...
      private function localNoop(param1:Object) : Object
      {
         return {"success":true, "data":{
            "money":RoleModel.getInstance().money,
            "exploit":RoleModel.getInstance().exploit,
            "dianka":RoleModel.getInstance().dianka,
            "rongyu":RoleModel.getInstance().rongyu
         }};
      }
      ...
      private function httpLogin(param1:Object) : Object
      {
         var raw:String = this.getLoginData();
         var data:Object = null;
         try { data = raw == "" ? {} : com.adobe.serialization.json.JSON.decode(raw); } catch(e:Error) { data = {}; }
         if(data.armyModel == null && data.roleModel == null)
         {
            // 早期版本新号的初始编制：鞠义、王平、陈震、吕翔、投石车。
            data.armyModel = [
               {id:8, code:"general_9_0", level:1, evolution:0, feature:0, genius:null, kezhi:"3:1|4:1|8:1"},
               {id:1, code:"general_1_0", level:1, evolution:0, feature:0, genius:null, kezhi:"5:1|7:1|9:1"},
               {id:3, code:"general_4_3", level:1, evolution:0, feature:0, genius:null, kezhi:"6:1|1:1|8:1"},
               {id:4, code:"general_3_0", level:1, evolution:0, feature:0, genius:null, kezhi:"2:1|1:1|6:1"},
               {id:5, code:"general_0_1", level:1, evolution:0, feature:0, genius:null, kezhi:""}
            ];
            data.bagModel = [];
            data.process = {finished:"", history:""};
            data.dianka = 0;
            data.roleModel = {score:"0", lostCount:"0", level:"1", winCount:"0", ranking:1, reverence:"0", roleID:20010901, exploit:"0", choose:"general_9_0|general_1_0|general_4_3|general_3_0|general_0_1", agent:"4399", money:"5000", userID:"offline", userName:"offline", exp:"0", roleName:"单机玩家", imageID:1};
         }
         if(data.roleModel == null) data.roleModel = {};
         if(data.armyModel == null) data.armyModel = [];
         if(data.bagModel == null) data.bagModel = [];
         if(data.process == null) data.process = {finished:"", history:""};
         if(data.dianka == null) data.dianka = 0;
         data.roleModel.userID = param1.userID || data.roleModel.userID || "offline";
         if(data.roleModel.roleName == null || data.roleModel.roleName == "") data.roleModel.roleName = "单机玩家";
         data.token = "offline-" + String(data.roleModel.userID);
         return {"success":true, "data":data, "message":"单机登录成功"};
      }
      ...
      private function httpRegister(param1:Object) : Object
      {
         var _loc2_:Object = {};
         _loc2_.success = true;
         // 新建单机用户必须从全新 Lv.1 模板开始，不能复用当前 data.json。
         _loc2_.data = {
            "armyModel":[
               {"id":8,"code":"general_9_0","level":1,"evolution":0,"feature":0,"genius":null,"kezhi":"3:1|4:1|8:1"},
               {"id":1,"code":"general_1_0","level":1,"evolution":0,"feature":0,"genius":null,"kezhi":"5:1|7:1|9:1"},
            ...
            "token":"offline-" + String(param1.userID),
            "bagModel":[],
            "roleModel":{"score":"0","lostCount":"0","level":"1","winCount":"0","ranking":1,"reverence":"0","roleID":int(20000000 + Math.random() * 999999),"exploit":"0","choose":"general_9_0|general_1_0|general_4_3|general_3_0|general_0_1","agent":"4399","money":"5000","userID":String(param1.userID),"userName":String(param1.userID),"exp":"0","roleName":String(param1.roleName || "单机玩家"),"imageID":int(param1.imageID || 1)},
            "process":{"finished":"","history":""},
            "dianka":0
         };
         return _loc2_;
      }
