package com.hurlant.math
{
   ...
   internal class MontgomeryReduction implements IReduction
   {
      ...
      public function reduce(param1:BigInteger) : void
      {
         ...
         {
            var _loc6_:*;
            param1.bi_internal::a[_loc6_ = _loc5_ = param1.t++] = 0;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.m.t)
         {
            _loc2_ = param1.bi_internal::a[_loc4_] & 32767;
            _loc3_ = _loc2_ * this.mpl + ((_loc2_ * this.mph + (param1.bi_internal::a[_loc4_] >> 15) * this.mpl & this.um) << 15) & BigInteger.DM;
            _loc2_ = _loc4_ + this.m.t;
            param1.bi_internal::a[_loc2_] += this.m.bi_internal::am(0,_loc3_,param1,_loc4_,0,this.m.t);
            while(param1.bi_internal::a[_loc2_] >= BigInteger.DV)
            {
               param1.bi_internal::a[_loc2_] -= BigInteger.DV;
               ++param1.bi_internal::a[++_loc2_];
            }
            _loc4_++;
         }
