package com.hurlant.crypto.hash
{
   ...
   public class MD2 implements IHash
   {
      ...
      public function hash(param1:ByteArray) : ByteArray
      {
         ...
         var _loc6_:uint = uint(uint(16 - param1.length % 16) || 16);
         do
         {
         ...
         while(_loc6_ < _loc7_)
         {
            ...
            while(_loc2_ < 16)
            {
               _loc9_ = uint(_loc8_[_loc2_] = _loc8_[_loc2_] ^ S[param1[_loc6_ + _loc2_] ^ _loc9_]);
               _loc2_++;
            }
            _loc6_ += 16;
         }
         ...
         while(_loc6_ < _loc7_)
         {
            ...
            while(_loc2_ < 18)
            {
               ...
               while(_loc4_ < 48)
               {
                  _loc10_[_loc4_] = _loc3_ = uint(_loc10_[_loc4_] ^ S[_loc3_]);
                  _loc4_++;
               }
               _loc3_ = uint(_loc3_ + _loc2_ & 255);
               _loc2_++;
            }
            _loc6_ += 16;
         }
