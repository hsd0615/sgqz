package com.hurlant.crypto.symmetric
{
   ...
   public class XTeaKey implements ISymmetricKey
   {
      ...
      public function encrypt(param1:ByteArray, param2:uint = 0) : void
      {
         ...
         {
            _loc4_ += (_loc5_ << 4 ^ _loc5_ >> 5) + _loc5_ ^ _loc6_ + this.k[_loc6_ & 3];
            _loc6_ += _loc7_;
            _loc5_ += (_loc4_ << 4 ^ _loc4_ >> 5) + _loc4_ ^ _loc6_ + this.k[_loc6_ >> 11 & 3];
            _loc3_++;
         }
         param1.position -= 8;
      ...
      public function decrypt(param1:ByteArray, param2:uint = 0) : void
      {
         ...
         while(_loc3_ < this.NUM_ROUNDS)
         {
            _loc5_ -= (_loc4_ << 4 ^ _loc4_ >> 5) + _loc4_ ^ _loc7_ + this.k[_loc7_ >> 11 & 3];
            _loc7_ -= _loc6_;
            _loc4_ -= (_loc5_ << 4 ^ _loc5_ >> 5) + _loc5_ ^ _loc7_ + this.k[_loc7_ & 3];
            _loc3_++;
         }
         param1.position -= 8;
         param1.writeUnsignedInt(_loc4_);
