   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         while(_loc13_ < 16)
         {
            if(param1)
            {
               _loc5_ = uint(_loc13_ << 1);
            }
            else
            {
               _loc5_ = uint(15 - _loc13_ << 1);
            }
            ...
            while(_loc12_ < 28)
            {
               if((_loc4_ = _loc12_ + totrot[_loc13_]) < 28)
               {
            ...
            while(_loc12_ < 56)
            {
               if((_loc4_ = _loc12_ + totrot[_loc13_]) < 56)
               {
                  _loc11_[_loc12_] = _loc10_[_loc4_];
               }
               else
            ...
            while(_loc12_ < 24)
            {
               ...
               {
                  _loc9_[_loc5_] |= bigbyte[_loc12_];
               }
               if(_loc11_[pc2[_loc12_ + 24]])
               {
                  _loc9_[_loc6_] |= bigbyte[_loc12_];
               }
               _loc12_++;
            }
            _loc13_++;
         ...
         while(_loc13_ != 32)
         {
            _loc7_ = uint(_loc9_[_loc13_]);
            _loc8_ = uint(_loc9_[_loc13_ + 1]);
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         while(_loc10_ < 8)
         {
            ...
            _loc6_ = uint(_loc6_ ^ param1[_loc10_ * 4 + 0]);
            _loc9_ = uint(SP7[_loc6_ & 63]);
            _loc9_ = uint(_loc9_ | SP5[_loc6_ >>> 8 & 63]);
            _loc9_ = uint(_loc9_ | SP3[_loc6_ >>> 16 & 63]);
            _loc9_ = uint(_loc9_ | SP1[_loc6_ >>> 24 & 63]);
            _loc6_ = uint(_loc7_ ^ param1[_loc10_ * 4 + 1]);
            _loc9_ |= SP8[_loc6_ & 63];
            _loc9_ = uint(_loc9_ | SP6[_loc6_ >>> 8 & 63]);
            _loc9_ = uint(_loc9_ | SP4[_loc6_ >>> 16 & 63]);
            _loc9_ = uint(_loc9_ | SP2[_loc6_ >>> 24 & 63]);
            _loc8_ ^= _loc9_;
            _loc6_ = uint(_loc8_ << 28 | _loc8_ >>> 4);
            _loc6_ = uint(_loc6_ ^ param1[_loc10_ * 4 + 2]);
            _loc9_ = uint(SP7[_loc6_ & 63]);
            _loc9_ = uint(_loc9_ | SP5[_loc6_ >>> 8 & 63]);
            _loc9_ = uint(_loc9_ | SP3[_loc6_ >>> 16 & 63]);
            _loc9_ = uint(_loc9_ | SP1[_loc6_ >>> 24 & 63]);
            _loc6_ = uint(_loc8_ ^ param1[_loc10_ * 4 + 3]);
            _loc9_ |= SP8[_loc6_ & 63];
            _loc9_ = uint(_loc9_ | SP6[_loc6_ >>> 8 & 63]);
            _loc9_ = uint(_loc9_ | SP4[_loc6_ >>> 16 & 63]);
            _loc9_ = uint(_loc9_ | SP2[_loc6_ >>> 24 & 63]);
