package game.display
{
   ...
   public class JiantaSoldier extends AbstractSoldier
   {
      ...
      public function JiantaSoldier(param1:ArmyInfo, param2:int = 1, param3:Boolean = false, param4:IWorld = null)
      {
      ...
      override protected function drawShadow() : *
      {
         ...
         _shadow.graphics.drawEllipse(-60,-5,120,10);
      ...
      override public function hurt(param1:int, param2:AbstractSoldier = null) : void
      {
         ...
         if(_armyInfo.hp < _maxHP * 0.4)
         {
            _skin._body1.gotoAndStop("_state2");
            _skin._body2.gotoAndStop("_state2");
         }
         if(_armyInfo.hp <= 0)
         {
            this.removeAllEvent();
      ...
      public function hurt2(param1:int) : *
      {
