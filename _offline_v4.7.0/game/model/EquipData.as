package game.model {
   public class EquipData {
      ...
      private static function init():void {
         ...
         _data["proto_4_82"]={slot:1,name:"灭世",attack:3944,attackPct:30,critRate:6,dmgBonus:3,levelReq:200,quality:10,iconIdx:56};
         ...
         _data["proto_4_40"]={slot:2,name:"锁子甲",defense:68,levelReq:20,quality:2,iconIdx:62};
         _data["proto_4_41"]={slot:2,name:"明光铠",defense:141,levelReq:35,quality:3,iconIdx:61};
         _data["proto_4_42"]={slot:2,name:"龙鳞甲",defense:221,defensePct:3,levelReq:55,quality:4,iconIdx:8};
         _data["proto_4_43"]={slot:2,name:"玄武战甲",defense:323,defensePct:6,dmgReduce:1,levelReq:75,quality:5,iconIdx:57};
         _data["proto_4_44"]={slot:2,name:"麒麟铠",defense:470,defensePct:9,dmgReduce:2,levelReq:100,quality:6,iconIdx:59};
         ...
         _data["proto_4_84"]={slot:2,name:"龙纹战甲",defense:3239,defensePct:28,dmgReduce:5,levelReq:185,quality:9,iconIdx:60};
         _data["proto_4_85"]={slot:2,name:"万古不朽",defense:4569,defensePct:35,dmgReduce:5,levelReq:200,quality:10,iconIdx:10};
         _data["proto_4_86"]={slot:2,name:"荆棘反甲",defense:3156,defensePct:25,dmgReduce:3,levelReq:170,quality:10,iconIdx:58};
         ...
         _data["proto_4_49"]={slot:3,name:"护心镜",dmgBonus:6,levelReq:40,quality:3,iconIdx:66};
         _data["proto_4_50"]={slot:3,name:"和氏璧",dmgBonus:8,lifesteal:3,levelReq:60,quality:4,iconIdx:22};
         _data["proto_4_51"]={slot:3,name:"天地令",dmgBonus:10,lifesteal:6,levelReq:80,quality:5,iconIdx:65};
         ...
         _data["proto_4_54"]={slot:3,name:"紫微星",dmgBonus:18,dmgReduce:10,lifesteal:15,levelReq:165,quality:8,iconIdx:63};
         ...
         _data["proto_4_73"]={slot:3,name:"金戒指",dmgBonus:8,levelReq:45,quality:3,iconIdx:68};
         ...
         _data["proto_4_76"]={slot:3,name:"乾坤圈",critRate:15,critDmg:15,levelReq:140,quality:6,iconIdx:64};
         _data["proto_4_95"]={slot:3,name:"破军环",critRate:20,critDmg:20,levelReq:160,quality:7,iconIdx:67};
