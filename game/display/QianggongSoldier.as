package game.display
{
   ...
   public class QianggongSoldier extends AbstractSoldier
   {
      ...
      public function QianggongSoldier(param1:ArmyInfo, param2:int = 1, param3:Boolean = false, param4:IWorld = null)
      {
