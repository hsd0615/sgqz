package game.display
{
   ...
   public class Boss extends AbstractSoldier
   {
      ...
      public var qunCount:int;
      
      public function Boss(param1:ArmyInfo, param2:int = 1, param3:Boolean = false, param4:IWorld = null)
      {
      ...
      override protected function drawShadow() : *
      {
         _shadow = new Shape();
         _shadow.graphics.beginFill(0);
         _shadow.graphics.drawEllipse(-25,-8,50,16);
         _shadow.filters = [new BlurFilter(10,6)];
         addChild(_shadow);
      }
      ...
      public function zhaohuan(param1:int) : *
      {
         dispatchEvent(new SoldierEvent(SoldierEvent.ZHAOHUAN,true,{"count":param1}));
      }
      ...
      override public function fire(param1:Object = null) : void
      {
         ...
         if(param1 != null && Boolean(param1.attackType))
         {
            this._attackType = int(param1.attackType);
         }
         ...
         else
         {
            ...
            _skin.gotoAndPlay("_attackBegin" + this._attackType);
         }
      }
      ...
      {
         if(_skin.currentFrameLabel == "_attackEnd1" || _skin.currentFrameLabel == "_attackEnd2")
         {
            removeEventListener(Event.ENTER_FRAME,this.onFireHandler);
            _fireing = false;
            this._canLeft = true;
            this._canRight = true;
            dispatchEvent(new SoldierEvent(SoldierEvent.FIRE_COMPLETE,true,{"attackType":this._attackType}));
