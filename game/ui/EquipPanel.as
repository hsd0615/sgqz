   ...
   public class EquipPanel extends Sprite
   {
      ...
      private function buildUI() : void
      {
         ...
         var _slotLayout:Array = [
            {label:"头盔", x:195, y:43},       // slot 3, top-center
            {label:"武器", x:5, y:123},        // slot 0, middle-left
            {label:"铠甲", x:195, y:123},      // slot 1, middle-center
            {label:"饰品Ⅰ", x:385, y:123},     // slot 2, middle-right
            {label:"战靴", x:100, y:187},      // slot 4, bottom-left
            {label:"饰品Ⅱ", x:290, y:187}      // slot 5, bottom-right
         ];
