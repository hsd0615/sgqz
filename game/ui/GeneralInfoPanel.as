   ...
   public class GeneralInfoPanel extends BaseUI
   {
      ...
      private function findEquipSlots() : void
      {
         ...
         var _slotPositions:Array = [
            {x:-332, y:-215},  // 0:武器   (左列,上排) 截图61,81
            {x:-148, y:-216},  // 1:铠甲   (右列,上排) 截图245,80
            {x:-330, y:-148},  // 2:饰品Ⅰ (左列,中排) 截图63,148
            {x:-146, y:-143},  // 3:头盔   (右列,中排) 截图247,153
            {x:-325, y:-84},   // 4:战靴   (左列,下排) 截图68,212
            {x:-147, y:-85}    // 5:饰品Ⅱ (右列,下排) 截图246,211
         ];
