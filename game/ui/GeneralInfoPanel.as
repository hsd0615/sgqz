package game.ui
{
   ...
   public class GeneralInfoPanel extends BaseUI
   {
      ...
      private function findEquipSlots() : void
      {
         ...
         // 换算: FlashX=1.3*截图X-440, FlashY=0.802*截图Y-250
         var _slotPositions:Array = [
            {x:-361, y:-185},  // 0:武器   (截图 61,81)
            {x:-122, y:-186},  // 1:铠甲   (截图 245,80)
            {x:-359, y:-132},  // 2:饰品Ⅰ (截图 63,148)
            {x:-119, y:-128},  // 3:头盔   (截图 247,153)
            {x:-352, y:-80},   // 4:战靴   (截图 68,212)
            {x:-121, y:-81}    // 5:饰品Ⅱ (截图 246,211)
         ];
