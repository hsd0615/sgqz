package game.model
{
   ...
   public class ArmyInfo
   {
      ...
      // 装备总加成, 敌人slot5(掉落槽)仅30%
      public function get equipAttackBonus():int { var _v:int = this.equipAttackFlat + this.equipAttackPctBonus; return this.isEnemy ? int(_v * 0.7) : _v; }
      public function get equipDefenseBonus():int { var _v:int = this.equipDefenseFlat + this.equipDefensePctBonus; return this.isEnemy ? int(_v * 0.7) : _v; }
      public function get equipHPBonus():int { var _v:int = this.equipHPFlat + this.equipHPPctBonus; return this.isEnemy ? int(_v * 0.7) : _v; }
